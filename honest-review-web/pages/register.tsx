                        ...
                        <Formik
                            ...
                            onSubmit={async (values,{setErrors})=>{
                                try {
                                    ...
                                    }else if(response.data?.register?.token && response.data?.register?.user){
                            ...
                            {({handleSubmit, isSubmitting, handleChange, values,errors})=>(
                                <form className="bg-white px-8 pt-6 pb-8 mb-4" onSubmit={handleSubmit}>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <input className={`shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${errors.username && "border-red-500"}`} id="username" type="text" placeholder="Username"
                                            onChange={handleChange}
